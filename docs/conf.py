...
latex_documents = [
    (master_doc, 'Penman.tex', 'Penman Documentation',
...
man_pages = [
    (master_doc, 'penman', 'Penman Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Penman', 'Penman Documentation',
     author, 'Penman', 'One line description of project.',
     'Miscellaneous'),
]
